...
public class Test {
	public static void main(String[] args) {
		...
		h.add(new HugeInteger("98765"));
		h.output();
		System.out.println("You should print 111110.");
		System.out.println("");

		h.sub(new HugeInteger("999998"));
		h.output();
		System.out.println("You should print -888888.");
		System.out.println("");

		h.add(new HugeInteger("-98765"));
		h.output();
		System.out.println("You should print -987653.");
		System.out.println("");

		h.add(new HugeInteger("987653"));
		h.output();
		System.out.println("You should print 0.");
		System.out.println("");
